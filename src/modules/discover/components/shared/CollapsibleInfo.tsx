...
import { CollapsibleInfoProps } from "../../types/discover.types";

/**
 * Collapsible info card component
 * Reusable info/instruction card following import-data pattern
 * Features colored background, icon, and expandable description
 */
