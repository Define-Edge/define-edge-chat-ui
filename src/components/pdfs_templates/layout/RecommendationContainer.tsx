...
export default function RecommendationContainer({
  ...
  return (
    <div className="flex-1">
      <div className="from-secondary to-primary-main-light rounded-md bg-gradient-to-r p-4 text-center text-white">
      ...
      <section className="border-primary-paper mt-[-2px] flex gap-6 rounded-md rounded-t-none border-2 border-t-0 px-6 pt-6 pb-10">
        <div className="flex">
          ...
          <div className="from-primary-main-light to-secondary w-[3px] bg-gradient-to-b" />
        </div>
        {content}
      </section>
    </div>
