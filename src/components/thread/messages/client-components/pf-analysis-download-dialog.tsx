...
export function PfAnalysisDownloadDialog({
  ...
  const mutation = useMutation({
    mutationFn: async () => {
      ...
      anchor.download = `${portfolioName || "portfolio"}_analysis.pdf`;
  ...
  const handleSelectAll = () => {
    setSelectedSections(PF_SECTIONS.map((s) => s.key));
  };
  ...
  const isAllSelected = selectedSections.length === PF_SECTIONS.length;
